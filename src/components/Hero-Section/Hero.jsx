  ...
  return (
    <div className='relative max-w-[1280px] font-roboto md:-mt-[20rem] -mt-[17rem] lg:pt-32 md:px-10 mx-auto pt-16'>
        ...
        <div className='flex'>
            ...
            <motion.div initial={{ opacity: 0, y: '-50%'}} animate={{ opacity: 1, y: 0}} exit={{ opacity: 0, y: '-50%'}} onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} className= 'absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                <motion.h1 initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.5,duration:0.3}} viewport={{once:false}} className="md:mt-24 lg:mt-28 sm:mt-10 relative z-2 text-[18px] md:text-[px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[25px] font-normal text-white">Pioneers of</motion.h1>
                <motion.h1 initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.5,duration:0.3}} viewport={{once:false}}  className="md:mt-0 lg:mt-0 sm:mt-0  mt-0  relative z-2 max-md:mb-5 text-[48px] md:text-[72px] 
                max-sm:leading-[60px] max-md:leading-[90px] uppercase lg:text-[80px] tracking-widest font-[800] text-white">Progress</motion.h1>
                <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.5,duration:0.3}} viewport={{once:false}} className=" font-[500] relative z-1 text-[19px] md:text-[28px]  lg:text-[22px] leading-[30px] md:leading-[36px] lg:leading-[30px] mb-5 md:mb-12 md:10/12 lg:w-8/12 text-[white]">
                we&apos;re not just a technology company, we&apos;re dedicated to shaping the future through innovation. With expertise spanning AI, finance, aerospace, electronics, and software development.
                </motion.p>
