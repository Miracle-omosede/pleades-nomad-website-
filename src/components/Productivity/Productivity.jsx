    ...
    <div className='max-w-[1280px] mx-auto font-roboto'>
        <div className='flex md:pl-10 space-x-3 md:space-x-10'>
            ...
            <div onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} className='md:w-10/12 mb-24'>
                <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.4, duration:0.3}} viewport={{once:false}} className="text-[20px] md:text-2xl mb-7 font-medium text-black js-build-in-item build-in-slideX-left build-in-animate" style={{transitionDelay: '200ms'}}>Software Solutions</motion.div>  
