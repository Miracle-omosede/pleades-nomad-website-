    ...
    <div className='max-w-[1280px] mx-auto font-roboto'>
         <div className='flex md:pl-7 space-x-3 md:space-x-10'>
            <div className='flex flex-col items-center'>
                <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.5}} className='relative'>
                  <svg aria-hidden="true" height="24" viewBox="0 0 24 24" version="1.1" width="24" fill='currentColor' data-view-component="true" className=" text-black">
            ...
            <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{delay:0.6, type:'tween'}} onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler}  className='md:w-10/12 mb-24'>
                <h2 className="text-[20px] md:text-2xl mb-7 font-medium text-black js-build-in-item build-in-slideX-left build-in-animate" style={{transitionDelay: '200ms'}}>Harness the Power of Data Science</h2>  
        ...
        <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                <HoverCard backgroundColor='#7ee787' direction='flex-row' left='0'>
                    <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32'  onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} >
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-black font-semibold'>By analysing your data from various angles, </span>  we uncover concealed patterns, trends, and connections that can give you a competitive advantage in your field.</p>
                        <div>
                    ...
                    <div className='overflow-hidden rounded-s-lg '>
                        <img className="w-full  h-auto js-build-in-item build-in-scale-fade build-in-animate" width="1209" height="890" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://miracle.sirv.com/pleiades-assets/green-code.png" />
                    </div>
                </HoverCard>
      ...
      <HoverCard backgroundColor='#ffa28b' direction='' left=''>
          <div className='md:flex flex-col md:space-y-20 flex-1 py-20 p-10  justify-between' onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} >
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-black font-medium'>The Pleiades Technologies team is driven by values of honesty and putting customers first</span> We focus on truly understanding our clients needs and collaborating closely with them to create customized solutions that go above and beyond their expectations.  </p>
              <div>
