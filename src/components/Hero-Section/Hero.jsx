    ...
    <div className='relative max-w-[1280px] font-roboto md:-mt-[20rem] -mt-[17rem] lg:pt-32 md:px-10 mx-auto pt-16'>
        ...
        <div className='flex'>
            ...
            <motion.div initial={{ opacity: 0, y: '-50%'}} animate={{ opacity: 1, y: 0}} exit={{ opacity: 0, y: '-50%'}} className= 'absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                ...
                As leading software development company with a relentless commitment to excellence. we have earned a reputation for delivering high-quality, scalable, and reliable software solutions that exceed our clients&apos; expectations
                </motion.p>
