    ...
    <>
      ...
      <div className="max-w-[1280px] mx-auto font-roboto md:mt-20 mt-5 px-8">
        <div className="flex md:pl-7 space-x-3 md:space-x-10">
          ...
          >
            <h2
              className="text-[20px] md:text-2xl mb-7  text-black js-build-in-item build-in-slideX-left build-in-animate font-bold"
              style={{ transitionDelay: "200ms" }}
            >
              About Us
            </h2>
            <h3
              className="text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-black js-build-in-item build-in-slideX-left build-in-animate"
