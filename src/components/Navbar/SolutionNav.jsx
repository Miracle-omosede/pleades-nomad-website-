  ...
  return (
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        <button onClick={() => setShow(!show)} type='button' className={`flex items-center p-1 max-lg:font-semibold transition ease-in duration-150 max-lg:justify-between max-lg:w-full ${show ? "lg:text-neutral-300 ": ""}`}>
            ...
            <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[300px] transition ease-in duration-300 ${show ? "lg:text-neutral-300" : "" }`}>
                <div className='lg:border-b-[1px] mb-4 pb-4 pt-4 w-full'>
                    ...
                    <ul className='text-sm text-neutral-500 mt-1 w-full'>
                        <li>
                            <a href='' className='block hover:text-blue-600'>Enterprise</a>
                            <a href='' className='block hover:text-blue-600'>Teams</a>
                            <a href='' className='block hover:text-blue-600'>Startups</a>
                        </li>
                        <li className='py-2'>
