    ...
    <div className='relative max-w-[1280px] font-roboto md:-mt-[20rem] -mt-[17rem] lg:pt-32 md:px-10 mx-auto pt-16'>
        ...
        <div className='flex'>
            ...
            <motion.div initial={{ opacity: 0, y: '-50%'}} animate={{ opacity: 1, y: 0}} exit={{ opacity: 0, y: '-50%'}} className= 'absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                ...
                max-sm:leading-[60px] max-md:leading-[90px] uppercase lg:text-[80px] tracking-widest font-[800] text-black">Innovation.</motion.h1>
                ...
                We are leading software development company with a relentless commitment to excellence. we have earned a reputation for delivering high-quality, scalable, and reliable software solutions that exceed our clients&apos; expectations.
                </motion.p>
                ...
                <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="#" className='flex items-center w-full md:w-auto justify-center text-[16px] py-3 px-5 max-md:mt-4 rounded-md border-[#ae88f9] border-[1.5px] text-black'>
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" className={` arrow-symbol-mktg text-black ml-3 transition ease-in duration-150 ${hovered1 ? "translate-x-0 ": "-translate-x-1"}`} width="20" height="20" viewBox="0 0 16 16" fill="none"><path fill="currentColor" d="M7.28033 3.21967C6.98744 2.92678 6.51256 2.92678 6.21967 3.21967C5.92678 3.51256 5.92678 3.98744 6.21967 4.28033L7.28033 3.21967ZM11 8L11.5303 8.53033C11.8232 8.23744 11.8232 7.76256 11.5303 7.46967L11 8ZM6.21967 11.7197C5.92678 12.0126 5.92678 12.4874 6.21967 12.7803C6.51256 13.0732 6.98744 13.0732 7.28033 12.7803L6.21967 11.7197ZM6.21967 4.28033L10.4697 8.53033L11.5303 7.46967L7.28033 3.21967L6.21967 4.28033ZM10.4697 7.46967L6.21967 11.7197L7.28033 12.7803L11.5303 8.53033L10.4697 7.46967Z"></path><path className={` text-black transition ease-in duration-150 ${hovered1 ? " opacity-100" : "opacity-0 "}`} stroke="currentColor" d="M1.75 8H11" strokeWidth="1.5" strokeLinecap ="round"></path></svg>
                </a>
                </div>
