    ...
    <div className='max-w-[1280px] mx-auto font-roboto'>
        ...
        <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                <HoverCard backgroundColor='#7ee787' direction='flex-col' left='0'>
                    ...
                    <div className='overflow-hidden rounded-s-lg ml-[48px]'>
                        <img className="w-full  h-auto js-build-in-item build-in-scale-fade build-in-animate" width="1209" height="890" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://miracle.sirv.com/pleiades-assets/wing.png" />
                    </div>
                </HoverCard>
